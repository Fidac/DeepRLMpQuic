...
class OfflineDQNAgent(DQNAgent):
    ...
    def __init__(self, model, policy=None, test_policy=None, enable_double_dqn=True, enable_dueling_network=False,
        ...
        super(OfflineDQNAgent, self).__init__(model, policy, test_policy, enable_double_dqn, enable_dueling_network,
    ...
    def fit(self, env, nb_steps, action_repetition=1, callbacks=None, verbose=1,
        ...
        try:
            while self.step < nb_steps:
                ...
                # Override with real action
                action = env.get_current_action()
