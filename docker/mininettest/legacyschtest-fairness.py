...
TCP_DUMP_TCP="tcpdump -i client-eth1 -nn \"src 10.0.0.20 and tcp\" > /App/logs/tcp_packets.logs 2>&1 &"
TCP_DUMP_MPQUIC="tcpdump -i client-eth1 -nn \"src 10.0.0.20 and udp\" > /App/logs/mpquic_packets.logs 2>&1 &"
...
def do_training(sch, rtt, tcp_b, dif_start, gap):
